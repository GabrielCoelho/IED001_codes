...
bool estaCheia_string() { return pl_posicao_string == TAMANHO; }

bool estaCheia_double() { return pl_posicao_double == TAMANHO; }

bool estaVazia_string() { return pl_posicao_string == 0; }

bool estaVazia_double() { return pl_posicao_double == 0; }
